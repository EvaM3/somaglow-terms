...
By downloading or using SomaGlow, you agree to these Terms and our Privacy Policy.
If you do not agree with any part, please do not use the app.

2) Eligibility & Accounts

You must meet the minimum age of digital consent in your country (typically 16+ in the EEA) or use the app with parental permission where allowed by law.
You are responsible for your device and for keeping it secure.

3) Description of the Service

SomaGlow provides somatic and mindfulness tools, including grounding exercises, body-based awareness practices, and calming sessions aimed at supporting relaxation and emotional regulation.

The app is designed for self-help and relaxation only and does not replace professional mental or physical healthcare.

4) Subscriptions, Trials & Payment

Free Trial (if offered): A free trial may be available. After the trial, your chosen plan renews automatically unless you cancel at least 24 hours before the period ends.
...
Do not use SomaGlow in any way that:
...
Unless stated otherwise, all content, features, and design in SomaGlow are owned by Eva Madarasz.
...
SomaGlow is not a medical device and does not diagnose, treat, or cure any condition.
...
We respect your privacy. SomaGlow does not collect personal data directly in-app.

Purchases and subscriptions are handled by Apple.
User-generated data (e.g., notes, preferences) is stored locally on your device unless you enable backups via your Apple settings.
For data deletion requests (GDPR/CCPA) related to purchases or support communication, email us with subject “SomaGlow Data Deletion Request” and include the Apple ID used. Some records may be retained as required by law.
10) Third-Party Services

SomaGlow may rely on Apple or platform-level services (e.g., in-app purchases, backups) and subscription infrastructure (e.g., RevenueCat).
Their terms and privacy policies apply when you use them.

11) Changes to These Terms

We may update these Terms from time to time.
The Effective Date above will always show the latest version.
